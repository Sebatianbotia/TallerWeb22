...
public class SeatInventoryImplTest {
    @Mock
    ...
    void shouldFindAllAndReturnResponseDTO(){
        ...
        assertThat(savedSeats.get(0).seatInventoryId()).isEqualTo(10L);
        assertThat(savedSeats.get(0).totalSeats()).isEqualTo(50);
        assertThat(savedSeats.get(0).availableSeats()).isEqualTo(40);
        assertThat(savedSeats.get(0).cabin()).isEqualTo(Cabin.ECONOMY);
        assertThat(savedSeats.get(0).flightNumber()).isNull();
